...
function AlbumCardInner({ album }: AlbumCardProps) {
  ...
  return (
    <PrefetchLink
      href={`/album/${album.id}`}
      className="group flex min-h-0 touch-manipulation flex-col overflow-hidden rounded-xl border border-white/[0.07] bg-zinc-900/50 transition hover:border-white/[0.13] hover:bg-zinc-800/50"
    >
