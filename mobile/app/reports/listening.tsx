...
const s = StyleSheet.create({
  ...
  shareText: { fontSize: 14, fontWeight: "600", color: theme.colors.gold },
  ...
  rangePillText: { fontSize: 11, fontWeight: "700", color: theme.colors.gold },
  ...
  heroLabel: { fontSize: 9, fontWeight: "600", color: theme.colors.gold, textTransform: "uppercase", letterSpacing: 0.7, marginBottom: 3 },
  ...
  movementUp: { fontSize: 11, fontWeight: "600", color: theme.colors.gold, minWidth: 36, textAlign: "right" },
  ...
  applyBtn: { backgroundColor: theme.colors.gold, borderRadius: 12, padding: 13, alignItems: "center" },
