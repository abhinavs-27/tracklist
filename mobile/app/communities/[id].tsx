...
const styles = StyleSheet.create({
  ...
  heroBackText: { color: theme.colors.gold, fontSize: 14, fontWeight: "600" },
  heroBody: {
    flexDirection: "row",
  ...
  tabLine: { position: "absolute", bottom: 0, left: "15%", right: "15%", height: 2, borderRadius: 1, backgroundColor: theme.colors.gold },
  ...
  modalSave: { fontSize: 16, fontWeight: "700", color: theme.colors.gold },
