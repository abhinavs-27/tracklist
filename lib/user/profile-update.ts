...
import { apiBadRequest, apiConflict, apiInternalError, apiOk } from "@/lib/api-response";
import { NextResponse } from "next/server";

/**
 * Centralized logic for updating a user profile.
 * Handles validation, username conflict checks, and Supabase persistence.
 */
