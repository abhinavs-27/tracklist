...
| `comments` | `(review_id) WHERE review_id IS NOT NULL` | `146` | Optimized for fetching comments for a review. |
| `comments` | `(log_id) WHERE log_id IS NOT NULL` | `146` | Optimized for fetching comments for a log (fallback schema). |
