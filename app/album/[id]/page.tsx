...
export default async function AlbumPage({ params }: { params: PageParams }) {
  ...
  const {
    ...
    async () => {
       ...
       * Catalog fetch is awaited before dependent stats/friends calls to ensure
       * canonical UUID resolution and potential upserts are complete.
       */
      ...
      /**
       * Phase 2: Parallelize independent secondary data fetching using a shared Supabase client
       * where possible to prevent RSC deadlocks and sequential waterfalls.
       */
