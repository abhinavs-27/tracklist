...
import { declineCommunityInvite } from "@/lib/community/invites";
import {
  apiBadRequest,
  apiForbidden,
  apiNotFound,
  ...
  async (_request, { user: me, params }) => {
    ...
    if (!result.ok) {
      switch (result.reason) {
        ...
        default:
          return apiBadRequest("Could not decline invite");
      }
    }
